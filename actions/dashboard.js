...
const serializeTransaction = (obj) => {
  //we are receiving objects in Prisma datatype, so need to convert that into dafe, javascript data types and obejcts thats why we are serializing it.
...
export async function createAccount(data) {
  //this is a server action, that ACTUALLY creates the account. Press Create Account, lekin create toh backend pe hoga, toh frontend se backend ke liye ek server action chahiye hota hai aur ye vo hi hai
  try {
